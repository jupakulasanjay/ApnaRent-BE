...
function buildPublicListingsWhere({ city, locality, bhk, maxRent, centroid, radiusKm }) {
...
export async function listPublicListings({
  ...
  const { whereSql, params, nextIdx, distanceExpr } = buildPublicListingsWhere({
    city, locality, bhk, maxRent, centroid, radiusKm
  })
  let i = nextIdx
...
export async function countPublicListings({ city, locality, bhk, maxRent, centroid, radiusKm }) {
