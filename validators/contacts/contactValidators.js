...
// A contact targets exactly one of a rental listing or a for-sale property.
export const createContactBody = z
  ...
  .refine((d) => (d.listing_id != null) !== (d.property_id != null), {
    message: "Provide exactly one of listing_id or property_id",
    path: ["listing_id"],
  });
