...
//
// Owners pick from this list when creating a listing; "Add custom" in the FE
// just sends a free-text string in the amenities[] array on write.
// We store amenity selections as TEXT[] on listings — slugs from this
// catalogue OR raw user-entered strings — so this file is purely a dropdown
// source, not a foreign-key table.
...
export const ICONS = {
  ...
  car: s(
    `<path d="M5 17h14M5 17l-2-5 2-5h14l2 5-2 5M5 17v3M19 17v3"/><circle cx="7.5" cy="17" r="1.5"/><circle cx="16.5" cy="17" r="1.5"/>`,
  ),
  dumbbell: s(`<path d="M2 12h2M20 12h2M6 8v8M18 8v8M9 6v12M15 6v12M9 12h6"/>`),
  pool: s(
    `<path d="M2 18c2 0 2-1 4-1s2 1 4 1 2-1 4-1 2 1 4 1 2-1 4-1M2 22c2 0 2-1 4-1s2 1 4 1 2-1 4-1 2 1 4 1 2-1 4-1M6 14V6a3 3 0 0 1 6 0M12 14V6a3 3 0 0 1 6 0"/>`,
  ),
  tree: s(
    `<path d="M12 22V12M8 12c-3 0-5-2-5-5s2-5 5-5h8c3 0 5 2 5 5s-2 5-5 5z"/><path d="M9 17l-2 5h10l-2-5"/>`,
  ),
  road: s(`<path d="M4 22 7 2h10l3 20"/><path d="M12 6v3M12 13v3M12 19v1"/>`),
  key: s(
    `<circle cx="8" cy="15" r="4"/><path d="m10.85 12.15 8.15-8.15M16 8l3 3M19 5l2 2"/>`,
  ),
  elevator: s(
    `<rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 8l3-3 3 3M9 16l3 3 3-3"/>`,
  ),
  flame: s(
    `<path d="M12 2s4 4 4 8a4 4 0 1 1-8 0c0-1 .5-2 1-3 0 2 1 3 2 3 0-3 1-5 1-8z"/>`,
  ),
  recycle: s(
    `<path d="M7 19l-3-3 3-3M3 16h12a3 3 0 0 0 3-3v-1M17 5l3 3-3 3M21 8H9a3 3 0 0 0-3 3v1"/>`,
  ),
  sun: s(
    `<circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41"/>`,
  ),
  wifi: s(
    `<path d="M5 12.55a11 11 0 0 1 14 0M8.5 16.43a6 6 0 0 1 7 0M2 8.82a15 15 0 0 1 20 0"/><circle cx="12" cy="20" r="0.5" fill="currentColor"/>`,
  ),
  coffee: s(
  ...
  wrench: s(
    `<path d="M14.7 6.3a4 4 0 0 0 5.4 5.4L21 12l-9 9-3-3 9-9z"/><path d="M9 11 3 17l3 3 6-6"/>`,
  ),
  ...
  package: s(
    `<path d="M16.5 9.4 7.55 4.24M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/>`,
  ),
  layout: s(
  ...
  return {
    ...
    amenities: items.map((item) => {
      if (typeof item === "string")
        return { slug: slugify(item), label: item, icon };
      return {
